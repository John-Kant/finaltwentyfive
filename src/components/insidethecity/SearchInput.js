...
//   const ClickMe = (e) => {
//     if (text !== "" && text1 !== "") {
//       const newArray = lineData.filter(
//         (item) =>
//           item.destination.includes(`${text}`) &&
...
//       var findPoint = result.map((item) => {
//         if (
//           result.indexOf(item) >= result.indexOf(`${text}`) &&
//           result.indexOf(item) <= result.indexOf(`${text1}`)
//         )
//           return item;
//       });
